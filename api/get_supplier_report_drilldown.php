...
// Remove normalization to match main report behavior
...
try {
    ...
    if ($fg_part !== '' && $fg_part !== $part_no) {
        $where .= " AND (t11.fg_part = :fg_part_filter OR t11.part_no = :fg_part_filter)";
        $params[':fg_part_filter'] = $fg_part;
    }
    ...
    if ($forecast_type !== '') {
        $where .= " AND t33.forecast_type = :forecast_type";
